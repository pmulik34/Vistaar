...
export const getTekdiallContent = async (header = {}) => {
  ...
  try {
    ...
    } else if (data?.apiEndPoint === "/cache/search") {
      // this is  api for Tekdi search
      const result = await post(`${baseUrl}/cache/search`, bodyData, {
        headers,
      });
      if (result.data) {
        return result.data;
...
export const getallContent = async (params = {}, header = {}) => {
  ...
  try {
    const result = await post(`https://vistaar-api.tekdinext.com/cache/search`);
    if (result.data) {
      return result.data;
    } else {
      return {};
...
export const getseletedData = async (params = {}, header = {}) => {
  ...
  try {
    const result = await post(`https://vistaar-api.tekdinext.com/select`, params, {
      headers,
    });
    if (result) {
      return result.data;
...
export const getconfirmdata = async (params = {}, header = {}) => {
  ...
  try {
    const result = await post(`https://vistaar-api.tekdinext.com/confirm`, params, {
      headers,
    });
    if (result) {
      return result.data;
